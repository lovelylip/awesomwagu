package com.silk.awesomeagu.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("awesomeagu");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("awesomeagu");
        ...
        config.getMapConfigs().put("com.silk.awesomeagu.domain.*", initializeDomainMapConfig(jHipsterProperties));
